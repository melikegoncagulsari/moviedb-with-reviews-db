  ...
  <div class="row">
    <div class="column">
      <div class="card">
        ...
        <p><a href="#" class="link" onclick="saveReview('new_review', 'new_user')">💾</a></p>
      </div>
    </div>
  </div>
`
            ...
            <div class="row">
                <div class="column">
                  <div class="card" id="${review._id}">
                      ...
                      <p><a href="#" class="link" onclick = "editReview('${review._id}','${review.review}','${review.user}')">✏️</a> <a href="#" class="link" onclick="deleteReview('${review._id}')">🗑️</a></p> 
                  </div>     
                </div>
              </div>
              `
...
function editReview(id, review, user) {
  ...
  element.innerHTML = `
    ...
    <p><a href="#" class="link" onclick="saveReview('${reviewInputId}','${userInputId}','${id}')">💾</a>
    `
}
